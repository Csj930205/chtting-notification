...
public class WebSocketHandler extends TextWebSocketHandler {
    ...
    private final Map<String, WebSocketSession> userList = new ConcurrentHashMap<>();
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        for (ChattingRoomParticipants participants : participantsList) {
            ...
            WebSocketSession sessions = userList.get(userId);
            if (sessions != null) {
                sessions.sendMessage(new TextMessage(objectMapper.writeValueAsString(result)));
            }
        }
    }
}
